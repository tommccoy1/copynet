# TP-Transformer. From https://github.com/ischlag/TP-Transformer
...
def build_transformer(input_dim=None, hidden=None, dropout=None, max_length=None, n_layers=None, n_heads=None, myfilter=None, pad_idx=None):
  ...
  p.d_x = hidden  # token embedding dimension
  p.d_p = hidden  # position embedding dimension
  ...
  embedding = EmbeddingMultilinearSinusoidal(d_vocab=input_dim,
                                             d_x=p.d_x,
                                             dropout=dropout,
                                             max_length=200)
  encoder = Encoder(p=p)
